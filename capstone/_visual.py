    ...
    for i in range(0,8):
        for piece in board:
            if xaxis.index(piece[1]) == i and 8-int(piece[2]) == j: 
                pieces.append(pygame.image.load(f"images/{images[piece[0]]}.png"))
                things.append(piece)
                        ...
                        if thing2[j] in list(moves[bonded].values())[0]:
                            ...
                            if (pos[bonded].x > i[0]-50 and pos[bonded].x < i[0]+50) and (pos[bonded].y > i[1]-50 and pos[bonded].y <i[1]+50):
                                ...
                                if "x" not in thing2[j]:
                                    playsound.playsound("sounds/move.mp3",block=False)

                                #play different sound for capture
                                else:
                                    playsound.playsound("sounds/takes.mp3",block=False)
                                ...
                                if king[1] == False:
                                    ...
                                    pygame.display.flip()
                                    playsound.playsound("sounds/mate.mp3")
                                    time.sleep(1)
                                    savegame(pgn)
                                    exit()
                ...
                if movemade == False:
                    ...
                    for j in range(0,8):
                        for i in range(0,8):
                            for piece in board:
                                if xaxis.index(piece[1]) == i and 8-int(piece[2]) == j: 
                                    pieces[board.index(piece)] = pygame.image.load(f"images/{images[piece[0]]}.png")
